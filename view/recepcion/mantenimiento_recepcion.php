...
if (isset($_SESSION['S_IDUSUARIO'])) {
  ...
  if (is_array($datos) and count($datos) > 0) {
    ...
    <!-- Modal registrar -->
    <div class="modal fade" id="modal_registro_recepcion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-lg-6   col-10">
                <label>Cliente:</label>
                <span class="text-danger" id="alerta_listanegra" style="display:none;">Cliente en lista Negra,
                  revisar</span>
                <select class="form-control form-control-sm js-example-basic-single" id="select_cliente" style="width:100%">
                </select>
              </div>
              ...
              <div class="col-lg-5 col-6">
                <label>Motivo:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_motivo" style="width: 100%">
                </select>
              </div>
              ...
              <div class="col-lg-8 col-12">
                ...
                <input type="text" id="text_accesorios" class="form-control form-control-sm" onkeyup="mayus(this);"
                  placeholder="Observacion">
              </div>
              <div class="col-lg-4 col-12">
                <label>Tecnico:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_tecnic" style="width: 100%">
                </select>
              </div>
              ...
              <div class="col-lg-4 col-4">
                ...
                <input type="number" id="text_monto" class="form-control form-control-sm" oninput="calcular();"
                  placeholder="Monto" value="0" disabled>
              </div>
              ...
              <div class="col-lg-4 col-4">
                ...
                <input type="text" id="text_debe" class="form-control form-control-sm" oninput="calcular();" value="0"
                  placeholder="0" disabled>
              </div>
              <div class="col-lg-6   col-10">
                <label>Sucursal:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_sucursal_r"
              ...
              <div class="col-12">
                <div class="card-header p-0 pt-1 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active small text" id="equipos-tab" data-toggle="pill" href="#equipos" role="tab"
                        aria-controls="equipos" aria-selected="true">Equipos Recepcionados</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link small text" id="insumos-tab" data-toggle="pill" href="#insumos" role="tab"
                        aria-controls="insumos" aria-selected="false">Insumos</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link small text" id="fotos-tab" data-toggle="pill" href="#fotos" role="tab"
                    ...
                    <div class="tab-pane fade active show" id="equipos" role="tabpanel" aria-labelledby="equipos-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                          ...
                          <input type="text" name="" class="form-control form-control-sm" id="text_equi2"
                            onkeyup="mayus(this);" placeholder="Equipo">
                        </div>
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                          ...
                          <input type="text" name="" class="form-control form-control-sm" id="text_monto2"
                            placeholder="Monto">
                        </div>
                        <div class="col-lg-3 col-6">
                          <label form="">Abono:</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_pendite2" value="0"
                            placeholder="Abono">
                        </div>

                        <div class="col-lg-11 col-12">
                          <label>Falla:</label>
                          <input type="text" id="text_concepto" class="form-control form-control-sm" onkeyup="mayus(this);"
                    ...
                    <div class="tab-pane fade" id="insumos" role="tabpanel" aria-labelledby="insumos-tab">
                      <div class="row">
                        <div class="col-lg-12 col-12">
                          ...
                          <select class="form-control form-control-sm js-example-basic-single" id="select_produc_ins"
                            style="width:100%"> </select>
                        </div>
                        ...
                        <div class="col-lg-3 col-4">
                          ...
                          <input type="text" name="" class="form-control form-control-sm" id="text_stock_insu"
                            placeholder="Stock" disabled>
                        </div>

                        <div class="col-lg-4 col-3">
                          <label for="">Precio</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_precio_insu"
                            placeholder="Stock">
                        </div>
                        ...
                        <div class="col-lg-4 col-4">
                          ...
                          <input type="number" name="" class="form-control form-control-sm" id="text_cantidad_ins"
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-info btn-lg  btn-sm" id="btnregistrarrecep"><i class="fa fa-save"></i> Registrar</button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-lg-8   col-8">
                ...
                <label>Cliente:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_cliente_editar"
                  style="width:100%"> </select>
              </div>
              <div class="col-lg-4 col-4">
                <label>Movil:</label>
              ...
              <div class="col-lg-4 col-xs-12" hidden>
                <label>Marca:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_marca_editar"
                  style="width: 100%"> </select>
              </div>
              <div class="col-lg-4 col-xs-12" hidden>
                <label>Modelo:</label>
              ...
              <div class="col-lg-4 col-4">
                <label>Motivo:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_motivo_editar"
                  style="width: 100%"> </select>
              </div>
              <div class="col-lg-4 col-4">
                <label>F. Entrega:</label>
              ...
              <div class="col-lg-12 col-12" hidden>
                <label>Observacion:</label>
                <input type="text" id="text_accesorios_editar" class="form-control form-control-sm" onkeyup="mayus(this);"
                  placeholder="Observacion">
              </div>
              <div class="col-lg-12 col-12">
                <label>Observacion:</label>
                <input type="text" id="text_concepto_editar" class="form-control form-control-sm" onpaste="return false"
                  placeholder="Falla del equipo">
              </div>
              ...
              <div class="col-lg-4 col-4">
                <label>Monto:</label>
                <input type="text" id="text_monto_editar" class="form-control  form-control-sm"
                  oninput="calcularAlEditar();" placeholder="Monto" disabled>
              </div>
              ...
              <div class="col-lg-4 col-4">
                <label>Adelanto:</label>
                <input type="text" id="text_adelanto_editar" class="form-control form-control-sm"
                  oninput="calcularAlEditar();" placeholder="Adelanto" disabled>
              </div>
              <div class="col-lg-4 col-4">
                <label>Pendiente:</label>
                <input type="text" id="text_debe_editar" class="form-control form-control-sm" oninput="calcularAlEditar();"
                  placeholder="Por Pagar" disabled>
              </div>

              <div class="col-lg-4   col-6">

                <label>Estado:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_estado_recepcion_editar"
                  style="width: 100%">
              ...
              <div class="col-lg-4 col-6">
                <label>Tecnico:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_tecnic_editar"
                  style="width: 100%"> </select>
              </div>
              <div class="col-lg-4   col-6">
                <label>Recoger:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_recoger_recepcion_editar"
                  style="width: 100%">
              ...
              <div class="col-lg-6   col-10">
                <label>Sucursal:</label>
                <select class="form-control form-control-sm js-example-basic-single" id="select_sucursal_editar"
                  style="width:100%"> </select>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card-header p-0 pt-1 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active small text" id="equipos_e-tab" data-toggle="pill" href="#equipos_e"
                        role="tab" aria-controls="equipos_e" aria-selected="true">Equipos Recepcionados</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link small text" id="insumos_e-tab" data-toggle="pill" href="#insumos_e" role="tab"
                        aria-controls="insumos_e" aria-selected="false">Insumos</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link small text" id="fotos_e-tab" data-toggle="pill" href="#fotos_e" role="tab"
                        aria-controls="fotos_e" aria-selected="false">Fotos</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade active show" id="equipos_e" role="tabpanel" aria-labelledby="equipos_e-tab">
                      <div class="row">
                        <div class="col-lg-3 col-6">
                          <label form="">Equipo:</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_equi2_e"
                            onkeyup="mayus(this);" placeholder="Equipo">
                        </div>
                        <div class="col-lg-3 col-6">
                        ...
                        <div class="col-lg-3 col-6">
                          <label form="">Monto :</label>
                          <input type="number" name="" class="form-control form-control-sm" id="text_monto2_e" value="0"
                            placeholder="Monto">
                        </div>
                        <div class="col-lg-3 col-6">
                          <label form="">Abono:</label>
                          <input type="number" name="" class="form-control form-control-sm" id="text_pendite2_e" value="0"
                            placeholder="Abono">
                        </div>
                        <div class="col-lg-11 col-12">
                          <label>Falla:</label>
                          <input type="text" id="text_falla_equip" class="form-control form-control-sm"
                            onkeyup="mayus(this);" placeholder="Falla del equipo">
                        </div>

                        <div class="col-1">
                          <label form="">&nbsp;</label><br>
                          <button class="btn btn-success btn-sm" id="btn_regis_directo_equipo"><i
                              class="fas fa-plus"></i></button>
                        </div>
                    ...
                    <div class="tab-pane fade" id="insumos_e" role="tabpanel" aria-labelledby="insumos_e-tab">
                      <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                          <label for="">Articulo</label>
                          <input type="text" id="idrepara_ins" hidden>
                          <select class="form-control form-control-sm js-example-basic-single" id="select_produc_ins_e"
                            style="width:100%"> </select>
                        </div>

                        <div class="col-lg-3 col-4">
                          <label for="">Stock</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_stock_insu_e"
                            placeholder="Stock" disabled>
                        </div>

                        <div class="col-lg-4 col-3">
                          <label for="">Precio</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_precio_insu_e"
                            placeholder="Stock" disabled>
                        </div>

                        <div class="col-lg-4 col-4">
                          <label for="">Cantidad</label>
                          <input type="text" name="" class="form-control form-control-sm" id="text_cantidad_ins_e"
                            placeholder="cantidad">
                        </div>

                        <div class="col-lg-1 col-1">
                          <label form="">&nbsp;</label><br>
                          <button class="btn btn-success btn-sm" id="btn_agregar_ins_e"
                            onclick="Registrar_insumos_al_Editar();"><i class="fas fa-plus"></i></button>
                        </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-lg-8   col-8">
                ...
                <label>Cliente:</label>
                <input type="cliente" id="select_cliente_ver" class="form-control form-control-sm" placeholder="movil"
                  disabled>
              ...
              <div class="col-lg-4 col-4">
                <label>Nro. Pedido:</label>
                <input type="text" id="text_codigo_r_ver" class="form-control form-control-sm" placeholder="Nro. Pedido"
                  disabled>
              </div>
              ...
              <div class="col-lg-4 col-4">
                ...
                <input type="text" id="select_motivo_ver" class="form-control form-control-sm" placeholder="motivo"
                  disabled>
              </div>
              <div class="col-lg-4 col-4">
                <label>F. Entrega:</label>
                <input type="date" id="text_fentrega_ver" class="form-control form-control-sm" placeholder="Accesorios"
                  disabled>
              </div>
              ...
              <div class="col-lg-12 col-12">
                <label>Observacion:</label>
                <input type="text" id="text_concepto_ver" class="form-control form-control-sm" onpaste="return false"
                  placeholder="Falla del equipo" disabled>
              </div>
              ...
              <div class="col-lg-4 col-4">
                <label>Adelanto:</label>
                <input type="text" id="text_adelanto_ver" class="form-control form-control-sm" placeholder="Adelanto"
                  disabled>
              </div>
              <div class="col-lg-4 col-4">
                <label>Pendiente:</label>
              ...
              <div class="col-lg-4   col-6">
                ...
                <label>Estado:</label>
                <input type="text" id="select_estado_recepcion_ver" class="form-control form-control-sm"
                  placeholder="Por Pagar" disabled>

              </div>
              <div class="col-lg-4 col-6">
                <label>Tecnico:</label>
                <input type="text" id="select_tecnic_ver" class="form-control form-control-sm" placeholder="Por Pagar"
                  disabled>

              </div>
              <div class="col-lg-4   col-6">
                <label>Recoger:</label>
                <input type="text" id="select_recoger_recepcion_ver" class="form-control form-control-sm"
                  placeholder="Por Pagar" disabled>

              </div>
              <div class="col-lg-4   col-6">
                <label>Monto Final:</label>
                <input type="text" id="text_monto_final_rec" class="form-control form-control-sm"
                  placeholder="monto final con servicio" disabled>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div class="card-header p-0 pt-1 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active small text" id="equipos_v-tab" data-toggle="pill" href="#equipos_v"
                        role="tab" aria-controls="equipos_v" aria-selected="true">Equipos Recepcionados</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link small text" id="insumos_v-tab" data-toggle="pill" href="#insumos_v" role="tab"
                        aria-controls="insumos_v" aria-selected="false">Insumos</a>
                    </li>
                  </ul>
                </div>
                <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12   col-xs-12">
                ...
                <select class="form-control form-control-sm js-example-basic-single" id="select_tipo_doc"
                  style="width: 100%">
                  <!-- <option selected="true" disabled>Seleccione Tipo Docmento..</option> -->
                  <option value="DNI" selected>DNI / NIF</option>
              ...
              <div class="col-lg-12 col-xs-12">
                <div class="form-check"><br>
                  <input class="form-check-input" type="checkbox" value="1" id="chkListanegra" name="chkListanegra">
                  <label class="form-check-label" for="chkListanegra">Lista <b>Negra</b></label>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-3 ">
                ...
                <button class="btn btn-danger btn-sm " data-toggle="tooltip" data-placement="top"
                  title="Impresion Constancia de Deposito" id="btn_deposito">Deposito</button>

              </div>

              <div class="col-lg-4 col-md-3 ">

                <button class="btn btn-primary btn-sm " data-toggle="tooltip" data-placement="top" title="Imprimir Ticket"
                  id="btn_ticket"> Ticket</button>

              </div>
              <div class="col-lg-4 col-md-3 ">

                <button class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top"
                  title="Enviar por Whatsapp" id="btn_whatsapp">Whatsapp</button>
              </div>

              <div class="col-lg-3 col-md-3 " hidden>

                <button class="btn btn-info btn-sm " data-toggle="tooltip" data-placement="top"
                  title="Imprimir Constancia de Datos" id="btn_datos">Datos</button>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-3 col-xs-12">
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="Si" name="text_enciende_si"
                      id="text_enciende_si">
                    <label class="form-check-label">Si</label>

                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="No" name="text_enciende_no"
                      id="text_enciende_no">
              ...
              <div class="col-12 mt-3">
                <div class="form-group">
                  <label for="text_foto_test">Adjuntar Imagen del Estado (Opcional):</label>
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="text_foto_test" accept="image/*">
                      <label class="custom-file-label" for="text_foto_test">Elegir archivo...</label>
                    </div>
                  </div>
                  <div id="pre_imagen_test" class="mt-2 text-center"></div>
                </div>
              </div>
    ...
    <!-- Modal de Firma -->
    <div class="modal fade" id="modal_firma" tabindex="-1" role="dialog" aria-labelledby="firmaModalLabel"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" id="text_idrece_firma" class="form-control form-control-sm mb-2">
            <canvas id="signature-pad" style="border:1px solid #ccc; width: 100%; height: 200px;"></canvas>
            <input type="hidden" name="firma_base64" id="firma_base64">
            <div class="mt-2">
              <button type="button" id="btn-limpiar-firma" class="btn btn-sm btn-warning">Limpiar</button>
              <button type="button" id="btn-guardar-firma" class="btn btn-sm btn-success">Guardar</button>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        // Cuando se abre el modal, inicializa el SignaturePad
        $('#modal_firma').on('shown.bs.modal', function () {
          const canvas = document.getElementById('signature-pad');
          resizeCanvas(canvas);
          signaturePad = new SignaturePad(canvas);
          signaturePad.clear(); // limpia al abrir
        });
        ...
        $('#btn-limpiar-firma').on('click', function () {
          if (signaturePad) {
            ...
            alert("La firma aún no está lista.");
          }
        });
        ...
        $('#btn-guardar-firma').on('click', function () {
          ...
          let idrecefirma = $('#text_idrece_firma').val();
          const dataURL = signaturePad.toDataURL(); // base64 de la imagen

          $.ajax({
            url: '../controller/recepcion/controlador_guardar_firma_cliente.php',
            type: 'POST',
            data: {
              idrecefirma: idrecefirma,
              firma_base64: dataURL
            }
          }).done(function (resp) {
            console.log(resp);
            if (resp > 0) {
              Swal.fire("Mensaje de Confirmación", "Firma Registrada", "success").then(() => {
      ...
      $("#btnregistrarrecep").on('click', function () {
        RegistrarRecepcion();
      });
      ...
      ********************************************************************/
      ...
      function cargar_Select_Productos() { //enviamos al scrpit mantenimiento examen
        let idalmacen = document.getElementById('text_idalmacen').value;
        let rolid = document.getElementById('text_idrol').value;
        ...
        $.ajax({
          ...
          select.select2({
            dropdownParent: $('#modal_registro_recepcion .modal-content'),
            width: '100%'
          });
        })
      }
      ...
      //MOSTRAR LA ALERTA SI EL CLIENTE ESTA EN LISTA NEGRA
      $('#select_cliente').on('change', function () {
        // Busca la opción que está actualmente seleccionada
        var optionSeleccionada = $(this).find('option:selected');

        // Obtiene todos los datos
        var clienteId = optionSeleccionada.val();
        var clienteLista = optionSeleccionada.data('listanegra');

        // Muestra todo en la consola
        //  console.log("--- Datos del Cliente Seleccionado ---");
        //console.log("ID:", clienteId);
        // console.log("Lista:", clienteLista);

        // --- AQUÍ LA NUEVA LÓGICA ---
        // Comprueba si el cliente está en la lista negra
        if (clienteLista === 'Si') {
          // Si es 'Si', muestra el span de alerta
          $('#alerta_listanegra').show();
        } else {
          // Si es cualquier otro valor (o está vacío), oculta el span
          $('#alerta_listanegra').hide();
        }
      });
      ...
      function cargar_Select_Insumos_Edit() { //enviamos al scrpit mantenimiento examen
        ...
        $.ajax({
          ...
          let select = $('#select_produc_ins_e');
          select.html(llenardata);
          ...
          select.select2({
            dropdownParent: $('#modal_editar_recepcion .modal-content'),
            width: '100%'
          });
