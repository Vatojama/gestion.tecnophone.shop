...
if (isset($_SESSION['S_IDUSUARIO'])) {
    ...
    if (is_array($datos) and count($datos) > 0) {
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-4" id="div_sucursal">
                        <label form="">Sucursal:</label>
                        <select class="form-control form-control-sm js-example-basic-single" id="select_sucur"
                            style="width: 100%"> </select>
                    </div>
                    <div class="col-2">
                        <label for="">&nbsp;</label><br>
                        <button class="btn btn-info btn-sm" style="width:100%" onclick="Traer_datos_widget_Graficos();"><i
                                class="fas fa-search"></i></button><br><br>
        ...
        // Esperamos a que cargue el combo de sucursal
        setTimeout(function () {
            if (document.getElementById('select_sucur').value != "") {
                Traer_datos_widget_Graficos();
            }
        }, 1000);
