                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-10 col-xs-10">
                                <label for="text_dni">Nro Doc.: </label>
                                <input type="text" id="text_dni" name="text_dni" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-xs-12">
                                <label for="text_nombre">Nombres: </label>
                                <input type="text" id="text_nombre" name="text_nombre" class="form-control form-control-sm"
                            ...
                            <div class="col-12 col-xs-12">
                                <label for="text_direccion">Direccion: </label>
                                <input type="text" id="text_direccion" name="text_direccion"
                                    class="form-control form-control-sm" placeholder="Direccion">
                            </div>

                            <div class="col-12 col-xs-12">
                                <label for="text_celular">Móvil: </label>
                                <input type="text" id="text_celular" name="text_celular" class="form-control form-control-sm"
                                    placeholder="Celular">
                            </div>

                            <div class="col-12 col-xs-12">
                                <label for="text_correo">correo: </label>
                                <input type="text" id="text_correo" name="text_correo" class="form-control form-control-sm"
                                    placeholder="Correo">
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12   col-xs-12" hidden>
                                ...
                                <label>Tipo Doc.:</label>
                                <select class="form-control form-control-sm js-example-basic-single" id="select_tipo_doc_editar"
                                    style="width: 100%">
                                    <!-- <option selected="true">Seleccione Tipo Docmento..</option> -->
                            ...
                            <div class="col-lg-12 col-xs-12">
                                <div class="form-check"><br>
                                    <input class="form-check-input" type="checkbox" value="1" id="chkListanegra_editar"
                                        name="chkListanegra_editar">
                                    <label class="form-check-label" for="chkListanegra_editar">Lista <b>Negra</b></label>
                                </div>
                            </div>
                        </div>
                    </div>
