                   ...
                   <div class="card card-gray shadow" style=" border: 1px solid gray;">
                       ...
                       <div class="card-body py-2">
                           <div class="row">
                               ...
                               <div class="col-lg-4 col-12" id="ocult_imei_vent" hidden>
                                    <label form="">Imei</label>
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control" id="select_imei" style="width:80%" hidden>
                                            <!-- opciones -->
                                        </select>
                                        
                                    </div>
                                </div>
                                <div class="col-lg-2 col-12" id="ocult_imei_vent_boton" hidden>
                                    <label form="">Imei</label>
                                    <div class="input-group">
                                         
                                        <a class="btn btn-info"   id="btnBuscarImei" data-toggle="modal" data-target="#modal_buscar_imei">
                                ...
                                <div class="col-lg-1" id="ocultar_boton" hidden>
                                    <label form="">&nbsp;</label><br>
                                        ...
                                        <table id="tabla_detalle_pro" class="display nowrap table-striped w-100 " style="width: 100%">
                                            <thead style="background: #4f5962;color: #ffffff;" class="small text left">
                                                <tr>
                                                    ...
                                                    <th class="ocultoimei" style="display: none;">#</th>
                                                </tr>
                                            </thead>
                           ...
                           <div class="form-group">
                               <div class="row">
                                   ...
                                   <div class="col-lg-12 col-12" id="efectivohabilitar" hidden>
                                       ...
                                       <input type="text" name="" class="form-control form-control-sm" id="text_efe">
                                   </div>
                                   ...
                                   <div class="col-lg-12 col-12" id="montoperacionhabilitar" hidden>
                                       ...
                                       <input type="text" name="" class="form-control form-control-sm" id="text_monto_t">
                                   </div>
                                    <div class="col-lg-12" >
...
<!-- Modal Buscar IMEI -->
<div class="modal fade" id="modal_buscar_imei" tabindex="-1" role="dialog" aria-labelledby="modalBuscarImeiLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalBuscarImeiLabel">Buscar IMEI</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <input type="text" class="form-control mb-2" id="buscador_imei_modal" placeholder="Buscar IMEI...">
        <table class="table table-bordered table-sm" id="tabla_imei_modal">
          <thead>
            <tr>
              <th>#</th>
              <th>IMEI</th>
          ...
          <tbody id="tbody_imei_modal">
            <!-- IMEI se llenan por JS -->
          </tbody>
        </table>
      </div>
      <div class="modal-footer">
   ...
   <script>
       ...
       $(document).ready(function() {
          ...
          // let sucurid = document.getElementById('text_idsucurs').value;
           ...
           $('#text_producto').select2({
                ...
                if (data.imei === 'Si') {
                    $('#text_stock').val(data.stock);
                    $('#text_precio').val(data.precio_venta);
                    $('#text_nombre_producto').val(data.text);
                    $('#text_tiene_imei').val(data.imei);
                    $('#text_idproducto').val(data.id);
                    $('#text_cantidad').val("1");
                    $('#text_descuento').val("0");
                    $("#ocult_imei_vent_boton").attr('hidden', false);
                    $("#ocultar_precio").attr('hidden', true);
                    $("#ocultar_descuento").attr('hidden', true);
                    $("#ocultar_cantidad").attr('hidden', true);
                    $("#ocultar_boton").attr('hidden', true);
                   // Traer_Imei_pro(data.id);
                  //  $("#text_producto").trigger('change');
                } else {
                    $('#text_stock').val(data.stock);
                    $('#text_precio').val(data.precio_venta);
                    $('#text_nombre_producto').val(data.text);
                    ...
                    $("#ocult_imei_vent_boton").attr('hidden', true);
                    $("#ocultar_precio").attr('hidden', false);
                    $("#ocultar_descuento").attr('hidden', false);
                    $("#ocultar_cantidad").attr('hidden', false);
                    $("#ocultar_boton").attr('hidden', false);
                   // $("#text_producto").trigger('change');
                }
       ...
       ********************************************************************/
       ...
       function cargar_Select_Productos2_oldddddd() { //enviamos al scrpit mantenimiento examen
           $.ajax({
               url: '../controller/venta/controlador_cargar_selectcombo_productos_venta.php',
               type: 'POST'
           }).done(function(resp) {
