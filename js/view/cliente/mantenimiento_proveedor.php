...
session_start();
    ...
    $rol = new Modelo_Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION['S_ROL'],35);// EL 35 ES MENU proveedor
    //var_dump($datos);
...
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12   col-xs-12" hidden>
                            ...
                            <select class="form-control form-control-sm js-example-basic-single" id="select_tipo_doc"
                                ...
                                <option value="R.U.C" selected>R.U.C</option>
                            </select>
                        </div>
 ...
 <!-- Modal Editar  -->
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12   col-xs-12">
                         ...
                         <div class="col-lg-12 col-xs-12">
                            <div class="form-check"><br>
                                <input class="form-check-input" type="checkbox" value="1" id="chkListanegra_editar" name="chkListanegra_editar" > 
                                <label class="form-check-label" for="chkListanegra">Lista <b>Negra</b></label>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal_compras_prove" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background:#343A40; color:white">
            <h5 class="modal-title" id="exampleModalLabel">Listado de Compras por Proveedor</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
 ...
 $('.js-example-basic-single').select2();
    ...
    $("#select_tipo_doc").change(function() {
        buscarDniRuc();
         ...
         $("#btn_buscarcompras").on('click', function() {
           let nombreproveeid = document.getElementById('idproveedor').value;
            Ver_detalle_compras(nombreproveeid);
        });
