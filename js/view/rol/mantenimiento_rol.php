...
session_start();
    ...
    $rol = new Modelo_Rol();
    $datos = $rol->validar_menu_x_rol($_SESSION['S_ROL'],16);// EL 2 ES MENU ROL
   // var_dump($datos);
...
?>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="input-group input-group-sm mb-3">
                ...
                <input type="text" id="text_rol_editar" class="form-control form-control-sm" onkeypress="return soloLetras(event)" placeholder="rol">
              </div>
              <div class="input-group input-group-sm mb-3">
                <div class="input-group-prepend">
    ...
    <!-- Modal PERMISOS -->
    <div class="modal fade" id="modal_registro_permisos" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background:#343A40; color:white">
            <h5 class="modal-title" id="exampleModalLabel">Seleccione Permiso</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="row">
            <input type="text" id="idrol_v" hidden>
              <div class="col-12">
                      <label form="">Vista Inicio:</label>
                      <select class="form-control form-control-sm js-example-basic-single" id="select_vista_ini" style="width: 100%"> </select>
                </div> 
              </div>
              <br>
              <div class="row">
              <div class="col-12 table-responsive">
                <table id="tabla_permisos" class="display compact" style="width: 100%;">
                  <thead style="background:#343A40; color:white" class="small text left">
                    <tr>
                      <th>Nombre </th>
